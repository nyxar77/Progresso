...
export function init() {
  document.getElementById("quizFile")?.addEventListener("change", async function() {
    ...
    if (file === undefined)
      throw Error("no file was seleted!")
  ...
  function mkQuiz(content: Quiz) {
    ...
    content.forEach((element, index) => {
      ...
      quizContainer.addEventListener("click", function() {
        const allContainers = document.querySelectorAll<HTMLDivElement>(".quiz-container");
      ...
      quizContainer.append(quizQuestion, quizQuestion, quizOptions, quizFeedback)
